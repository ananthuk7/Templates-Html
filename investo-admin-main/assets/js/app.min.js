! function (l) {
    ...
    t.prototype._reset = function () {
        ...
        var i = this,
            ...
            n = e.size ? e.size : "default";
        this._reset(), l(".button-menu-mobile").on("click", function (t) {
            t.preventDefault();
            var e = i.body.attr("data-sidebar-size");
            993 <= i.window.width() ? "condensed" === e ? (i.changeSize(n), window.dispatchEvent(new Event("adminto.setFluid"))) : (i.changeSize("condensed"), window.dispatchEvent(new Event("adminto.setBoxed"))) : (i.changeSize(n), i.body.toggleClass("sidebar-enable"), window.dispatchEvent(new Event("adminto.setFluid")))
        }), l("#side-menu").length && ((a = l("#side-menu li .collapse")).on({
            ...
            if (this.href == t) {
                ...
                var n = l(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent();
                n.is("body") || n.addClass("menuitem-active")
            }
        }));
        if (l("#two-col-sidenav-main").length) {
            var a, o = l("#two-col-sidenav-main .nav-link"),
                s = l(".twocolumn-menu-item"),
                r = l(".twocolumn-menu-item .nav-second-level");
            (a = l("#two-col-menu li .collapse")).on({
                "show.bs.collapse": function () {
                    var t = l(this).closest(r).closest(r).find(a);
                    t.length ? t.not(l(this)).collapse("hide") : a.not(l(this)).collapse("hide")
                }
            ...
            o.each(function () {
                ...
                if (this.href == d) {
                    ...
                    var n = null,
                        a = "#" + l(this).parents(".twocolumn-menu-item").attr("id");
                    l("#two-col-sidenav-main .nav-link").each(function () {
                        l(this).attr("href") === a && (n = l(this))
                    }), n && n.trigger("click")
                }
            })
        }
...
function (a) {
    ...
    t.prototype.initMenu = function () {
        ...
        }), a(".topbar-dropdown").on("show.bs.dropdown", function () {
            a("#search-dropdown").removeClass("d-block")
        }), a(".navbar-nav a").each(function () {
            var t = window.location.href.split(/[?#]/)[0];
            if (this.href == t) {
                if (a(this).addClass("active"), a(this).parent().addClass("active"), a(this).parent().parent().addClass("active"), a(this).parent().parent().parent().addClass("active"), a(this).parent().parent().parent().parent().addClass("active"), a(this).parent().parent().parent().parent().hasClass("mega-dropdown-menu")) a(this).parent().parent().parent().parent().parent().addClass("active"), a(this).parent().parent().parent().parent().parent().parent().addClass("active");
                else {
                    var e = a(this).parent().parent()[0].querySelector(".dropdown-item");
                    if (e) {
                        t = window.location.href.split(/[?#]/)[0];
                        e.href != t && !e.classList.contains("dropdown-toggle") || e.classList.add("active")
                    }
                }
                var i = a(this).parent().parent().parent().parent().addClass("active").prev();
        ...
        t.forEach(function (i) {
            i.addEventListener("click", function (t) {
                if (!i.parentElement.classList.contains("nav-item")) {
                    n = !0, i.parentElement.parentElement.classList.add("show");
                ...
                n && (t.preventDefault(), t.stopPropagation(), n = !1)
            })
        })
    }, t.prototype.changeColor = function (t) {
...
function (a) {
    ...
    function t() {
        this.body = a("body"), this.window = a(window), this.config = {}, this.defaultBSStyle = a("#bs-default-stylesheet"), this.defaultAppStyle = a("#app-default-stylesheet"), this.darkBSStyle = a("#bs-dark-stylesheet"), this.darkAppStyle = a("#app-dark-stylesheet")
    }
    t.prototype._saveConfig = function (t) {
        this.config = a.extend(this.config, t)
        ...
        switch (t) {
            case "boxed":
                this.body.attr("data-layout-width", "boxed"), a.LeftSidebar.changeSize("condensed"), window.dispatchEvent(new Event("adminto.setBoxed")), this._saveConfig({
                    width: t
                });
                break;
            default:
                ...
                a.LeftSidebar.changeSize(e && e.sidebar ? e.sidebar.size : "default"), this._saveConfig({
                    width: t
        ...
        this.leftSidebar = a.LeftSidebar, this.topbar = a.Topbar, ((this.leftSidebar.parent = this).topbar.parent = this).applyConfig()
    ...
    t.prototype.initTooltipPlugin = function () {
        ...
        o('[data-plugin="peity-pie"]').each(function (t, e) {
            var i = o(this).attr("data-colors") ? o(this).attr("data-colors").split(",") : [],
                n = o(this).attr("data-width") ? o(this).attr("data-width") : 20,
                a = o(this).attr("data-height") ? o(this).attr("data-height") : 20;
            o(this).peity("pie", {
                fill: i,
                width: n,
                height: a
...
function (i) {
    ...
    t.prototype.initControls = function () {
        function t() {
            document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement || i("body").removeClass("fullscreen-enable")
        }
        setTimeout(function () {
            document.body.classList.remove("loading")
        }, 350), i(window).on("load", function () {
        ...
        window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnPageLoad") && t.showRightSidebarOnPageLoad && (sessionStorage.getItem("_ADMINTO_VISITED_") || (i.RightBar.toggleRightSideBar(), sessionStorage.setItem("_ADMINTO_VISITED_", !0)));
